...
test_batches = ImageDataGenerator(preprocessing_function=tf.keras.applications.vgg16.preprocess_input) \
    ...
    batch_size=10,
     shuffle=False,
      class_mode='sparse')
"""
train_batches = ImageDataGenerator(rescale=1./255).flow_from_directory(directory=train_path, target_size=(224,224), batch_size=10, class_mode='sparse')
valid_batches = ImageDataGenerator(rescale=1./255).flow_from_directory(directory=valid_path, target_size=(224,224), batch_size=10, shuffle = False,class_mode='sparse')
test_batches = ImageDataGenerator(rescale=1./255).flow_from_directory(directory=test_path, target_size=(224,224),  batch_size=10, shuffle=False,class_mode='sparse')
"""
base_model = VGG16(
    include_top=True,
    weights="imagenet",
...
# model.add(MaxPool2D(pool_sie=2, strides=2, padding='valid'))
