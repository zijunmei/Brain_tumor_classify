...
train_batches = ImageDataGenerator(preprocessing_function=tf.keras.applications.vgg16.preprocess_input) \
    .flow_from_directory(directory=train_path, target_size=(299,299), classes=['glioma', 'meningioma', 'notumor','pituitary'], batch_size=20, class_mode='sparse')
valid_batches = ImageDataGenerator(preprocessing_function=tf.keras.applications.vgg16.preprocess_input) \
    .flow_from_directory(directory=valid_path, target_size=(299,299), classes=['glioma', 'meningioma', 'notumor','pituitary'], batch_size=20,shuffle = False, class_mode='sparse')
test_batches = ImageDataGenerator(preprocessing_function=tf.keras.applications.vgg16.preprocess_input) \
    .flow_from_directory(directory=test_path, target_size=(299,299), classes=['glioma', 'meningioma', 'notumor','pituitary'], batch_size=20, shuffle=False, class_mode='sparse')
